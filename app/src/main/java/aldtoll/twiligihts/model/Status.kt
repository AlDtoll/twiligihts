...
data class Status(
    ...
    /**
     * если true и применяемое значение статуса [Effect.EditStatus.value] равно 0,
     * то сообщение в боевом логе не выводится
     */
    val skipZero: Boolean = false,
    /**
     * если true, строки лога об этом статусе помечаются как технические (их можно скрыть в UI).
     */
